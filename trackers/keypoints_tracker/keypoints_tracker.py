...
class TrKeypoints(Tracker):
    ...
    def __init__(
        ...
        if model_path is not None and fixed_keypoints_detection is None:
    ...
    def video_info_post_init(self, video_info: sv.VideoInfo) -> "TrKeypoints":
        return self
